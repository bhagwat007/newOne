...
import androidx.recyclerview.widget.RecyclerView;
    ...
    public class CompletedMatchAdapter extends RecyclerView.Adapter<CompletedMatchAdapter.ViewHolder> {
        ...
        private List<CompletedMatchData> mroundList;
        private Context mactivity;

        public CompletedMatchAdapter(Context context, List<CompletedMatchData> roundList) {
        ...
        @NonNull
        @Override
        public com.example.myapplication.CompletedMatchAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mactivity).inflate(R.layout.liveadapter, parent, false);

            return new CompletedMatchAdapter.ViewHolder(view);

        }

        @Override
        public void onBindViewHolder(@NonNull com.example.myapplication.CompletedMatchAdapter.ViewHolder holder, int position) {
            CompletedMatchData roundList = mroundList.get(position);
