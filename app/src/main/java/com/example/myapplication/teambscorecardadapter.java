...
public class teambscorecardadapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private List<DataScorecad> mroundList;
    private Context mactivity;

    public teambscorecardadapter(Context context, List<DataScorecad> roundList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        switch (mroundList.get(position).getViewType()) {
            case 0:
                DataScorecad roundList = mroundList.get(position);
...
//                bowlerlayoutholder.score6s.setText(tossdata1);
                break;
