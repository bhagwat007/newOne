...
public class bowlerScorecard {
    ...
    public bowlerScorecard(int viewType,String scorebatsmenname, String scoreruns, String scoreballs, String score4s, String score6s, String scoressr, String howsout) {
    ...
    public bowlerScorecard( int viewType,String bowlername, String overs, String runs, String maiden, String wickets, String economy) {
