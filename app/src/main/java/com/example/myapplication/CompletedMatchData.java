...
public class CompletedMatchData {
        ...
        public CompletedMatchData(String teama, String teamb,String compition, String status, String teamascore, String teambsxcore, String toss,String livematch_url) {
            mteam1 = teama;
            mteam2 = teamb;
